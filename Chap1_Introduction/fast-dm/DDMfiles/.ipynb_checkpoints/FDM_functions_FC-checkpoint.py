...
def generate_files(dataset, free = {}, fixed = {}, method=None, precision=3):
    cols = ['RT','response','contrast','SAT','FC']
...
#==============================================================================
        ...
        cfg_file.write('format TIME RESPONSE contrast SAT FC\n')
...
def get_parameters():
    ...
    for f in list_dir:
        ...
        if i == "parameter":#only file with parameter* taken
            ...
            par.loc[par['index'].str.contains('one'), 'FC'] = '1'
            par.loc[par['index'].str.contains('two'), 'FC'] = '2'
            par.loc[par['index'].str.contains('1'), 'contrast'] = 1
            par.loc[par['index'].str.contains('2'), 'contrast'] = 2
            par.loc[par['index'].str.contains('3'), 'contrast'] = 3
            par.loc[par['index'].str.contains('4'), 'contrast'] = 4
            par.loc[par['index'].str.contains('5'), 'contrast'] = 5
            par.loc[par['index'].str.contains('6'), 'contrast'] = 6
            parameter = []
