...
alternate = NtrialsSession/10 #number of trials per successive condition
Ntrials = NtrialsSession/20 #number of trials before feedback
...
trials=data.TrialHandler(nReps=NtrialsSession/Ntrials, method=u'random',
    ...
    trialList=data.importConditions('Stimuli'+os.sep+'Stimuli.csv'))
...
#Clue
    ...
    fixation.draw()
    win.flip()
    trigger = str(triggerToAdd)+str(trigger)
