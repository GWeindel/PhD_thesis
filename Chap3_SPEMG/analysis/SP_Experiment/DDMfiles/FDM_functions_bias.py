...
def generate_files(dataset, free = {}, fixed = {}, method=None, precision=3):
    cols = ['RT','response','p_right','SAT','stimulus']
...
#==============================================================================
        ...
        cfg_file.write('format TIME RESPONSE p_right SAT stimulus\n')
...
def get_parameters():
    ...
    for f in list_dir:
        ...
        if i == "parameter":#only file with parameter* taken
            ...
            par.loc[par['index'].str.contains('50'), 'p_right'] = 50
            par.loc[par['index'].str.contains('70'), 'p_right'] = 70
            par.loc[par['index'].str.contains('30'), 'p_right'] = 30
